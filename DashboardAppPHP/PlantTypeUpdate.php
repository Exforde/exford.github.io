<?php 
    ...
    $conn = dbconnect();
    $plantType = GetPlantType($conn, $_GET['key']);
    $plantTypeData = $plantType->fetch_assoc();
    $conn->close();
?>
...
<html>
    <head>
        <title>Dashboard - Plant Type Update</title>
            ...
            <div id="content-body">
                ...
                <div class="box">
                    <div class="box-header">
                        <h3>PLANT TYPE UPDATE</h1>
                    </div>
                    <div class="box-body">
                        <form action="/DashboardAppPHP/FormUpdatePlantType.php" method="POST">
                            <div class="form-item">
                                <div class="info-left">Id:</div>
                                <div class="info-right"><?php echo $plantTypeData['PLANTTYPEKEY'] ?></div>
                                <input type="number" value="<?php echo $plantTypeData['PLANTTYPEKEY'] ?>" name="plantTypeKey" hidden readonly />
                            </div>
                            <div class="form-item">
                                <div class="info-left">Type Name:</div>
                                <div class="info-right"><input type="text" name="typeName" value="<?php echo $plantTypeData['TYPENAME'] ?>" /></div>
                            </div>
                            <div class="form-item">
                                ...
                                <button class="btn btn-default" type="submit" style="width: 150px; margin-top: 10px;">Update Type</button>
                            </div>
                        </form>
                    </div>
                </div>
