<?php 
    ...
    $conn = dbconnect();
    $hardwareType = GetHardwareType($conn, $_GET['key']);
    $hardwareTypeData = $hardwareType->fetch_assoc();
    $conn->close();
?>
            ...
            <div id="content-body">
                ...
                <div class="box">
                    <div class="box-header">
                        <h3>HARDWARE TYPE UPDATE</h1>
                    </div>
                    <div class="box-body">
                        <form action="/DashboardAppPHP/FormUpdateHardwareType.php" method="POST">
                            <div class="form-item">
                                <div class="info-left">Id:</div>
                                <div class="info-right"><?php echo $hardwareTypeData['HARDWARETYPEKEY'] ?></div>
                                <input type="number" value="<?php echo $hardwareTypeData['HARDWARETYPEKEY'] ?>" name="hardwareTypeKey" hidden readonly />
                            </div>
                            <div class="form-item">
                                <div class="info-left">Hardware Type Name:</div>
                                <div class="info-right"><input type="text" value="<?php echo $hardwareTypeData['TYPENAME'] ?>" name="typeName" /></div>
                            </div>
                            <div class="form-item">
