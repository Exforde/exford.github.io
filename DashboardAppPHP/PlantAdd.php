...
<html>
    <head>
        <title>Dashboard - Plant Add</title>
        ...
        <div id="content">
            ...
            <div id="content-body">
                ...
                <div class="box">
                    ...
                    <div class="box-body">
                        <form action="/DashboardAppPHP/FormAddPlant.php" method="POST">
                            <div class="form-item">
                                <div class="info-left">Plant Name:</div>
                                <div class="info-right"><input type="text" name="plantName" /></div>
                            </div>
                            <div class="form-item">
                                    ...
                                    <select name="plantType">
                                        ...
                                        <?php if(mysqli_num_rows($plantType) > 0) { ?>
                                            <?php while($row = $plantType->fetch_assoc()) { ?>
                                                <option value="<?php echo $row['PLANTTYPEKEY'] ?>"><?php echo $row['TYPENAME'] ?></option>
                                            <?php } ?>
                                        <?php } ?>
                                    </select>
                                </div>
                            ...
                            <div class="form-item">
                                ...
                                <button class="btn btn-default" type="submit" style="width: 150px; margin-top: 10px;">Add Plant</button>
                            </div>
                        </form>
                    </div>
                </div>
